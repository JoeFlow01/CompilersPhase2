...
test=["exp->term exp'", "term->factor term'", 'factor->( exp )', 'Matched', "exp->term exp'", "term->factor term'", 'factor->num', 'Matched', "term'->#", "exp'->addop term exp'", 'addop->-', 'Matched', "term->factor term'", 'factor->num', 'Matched', "term'->#", "exp'->addop term exp'", 'addop->-', 'Matched', "term->factor term'", 'factor->num', 'Matched', "term'->#", "exp'->#", 'Matched', "term'->#", "exp'->#"]
